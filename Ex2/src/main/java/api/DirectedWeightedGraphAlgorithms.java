...
/**
 * This interface represents a Directed (positive) Weighted main.Graph Theory Algorithms including:
 * 0. clone(); (copy)
 * 1. init(graph);
...
public interface DirectedWeightedGraphAlgorithms {
     ...
     * Assuming the graph isConnected, elese return null. See: https://en.wikipedia.org/wiki/Graph_center
     * @return the main.Node data to which the max shortest path to all the other nodes is minimized.
     */
